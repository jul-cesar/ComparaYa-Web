...
const InfoHeader = ({ currentCategory, AllProducts, currentItems }) => {
  return (
    <div className="flex flex-row mt-[60px] pt-1 pb-2 sm:p-4 border-b-2 justify-between items-center border-gray-800 shadow-sm sm:mt-8 mb-6 mx-2 sm:flex  sm:justify-between">
