...
const InfoHeader = ({ currentCategory, AllProducts, filteredItems }) => {
  return (
    <div className="flex flex-row p-2 sm:p-4 border-b-2 justify-between items-center border-gray-800 dark:border-white shadow-sm mt-14 mb-6 mx-4 sm:flex  sm:justify-between">
