...
const CategoriesSidebar = ({ setCurrentCategory }) => {
  const { setProducts, setFilteredItems, setLoadingProducts, openSidebar, setOpenCarrito, openCarrito, productsInCart } =
    useContext(Products);
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Carrito</span>
