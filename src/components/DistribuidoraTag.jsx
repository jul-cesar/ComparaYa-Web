...
const DistribuidoraTag = ({ precio_exito, precio_olim, precio_d1 }) => {
  return (
    <div className="flex items-center m-2 sm:mt-3 sm:mb-5">
      ...
      {precio_d1 > 0 && (
        <span className="bg-blue-100 text-red-600  text-xs sm:text-sm font-semibold px-2.5 py-0.5 rounded dark:bg-blue-200">
          D1
        </span>
      )}
      {precio_olim > 0 && (
        <span className="bg-blue-100 text-blue-800  text-xs sm:text-sm font-semibold px-2.5 py-0.5 rounded dark:bg-blue-200">
          Olimpica
        </span>
      )}
    </div>
